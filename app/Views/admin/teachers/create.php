...
<div style="margin-bottom: 2rem;">
    ...
    <h2 style="font-weight: 700; font-size: 1.5rem; margin-top: 1rem;">Tambah Guru Baru</h2>
</div>
    ...
    <form action="<?= base_url('admin/teachers/store') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="bio" id="bio" class="form-control" rows="4"
                placeholder="Deskripsi singkat mengenai guru..."><?= old('bio') ?></textarea>
        </div>

        <div class="form-group">
            <label for="photo">Foto Profil</label>
            <input type="file" name="photo" id="photo" class="form-control" accept="image/*">
            <p style="font-size: 0.8rem; color: #94A3B8; margin-top: 0.5rem;">Format: JPG, PNG. Maksimal 2MB.</p>
        </div>
